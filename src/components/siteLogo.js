...
const Logo = () => (
    <div className="flex justify-center mb-20">
        <Link className="site-logo relative" to="/" title="Jam Heroes">
            <span className="triangle relative block bg-white transform skew-x-6 skew-y-6"></span>
            <span className="text-1 absolute top-2 left-0 right-0 flex justify-center text-8xl font-black text-indigo-900 uppercase">
                jam
            </span>
